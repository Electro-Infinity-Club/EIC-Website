export const faqs = [
  ...
  {
    id: 3,
    question: "What are the activities held by the Electro Infinity Club ?",
    answer: "The activities of the club are based on the electronic domains to make students engage, build connections, interact with peers, explore new opportunities.",
  },
  {
    id: 4,
